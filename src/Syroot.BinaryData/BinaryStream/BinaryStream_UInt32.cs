...
namespace Syroot.BinaryData
{
    public partial class BinaryStream
    {
        ...
        /// <returns>The value read from the current stream.</returns>
        public async Task<UInt32> ReadUInt32Async(CancellationToken cancellationToken = default)
        ...
        /// <param name="value">The value to write.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public async Task WriteAsync(UInt32 value, CancellationToken cancellationToken = default)
