...
namespace Syroot.BinaryData
{
    public partial class BinaryStream
    {
        ...
        /// <returns>The value read from the current stream.</returns>
        public async Task<Int32> ReadInt32Async(CancellationToken cancellationToken = default(CancellationToken))
        ...
        /// <param name="value">The value to write.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public async Task WriteAsync(Int32 value, CancellationToken cancellationToken = default(CancellationToken))
        ...
        /// <param name="value">The value to write.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public async Task WriteInt32Async(Int32 value, CancellationToken cancellationToken = default(CancellationToken))
            => await BaseStream.WriteAsync(value, ByteConverter, cancellationToken);
